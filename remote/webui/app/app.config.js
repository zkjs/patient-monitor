...
(function(){
  ...
  var baseurl = 'http://zkjsbeta:8001',
  //var baseurl = 'http://192.168.1.104:8011',
    map = '/map/', devices = '/devices/';

  require('angular').module('demo')

  .constant('CONST', {
    'URL_SAVEDRAWING': baseurl + map + ':partid/drawing',
    'URL_ORGLIST': baseurl + map + 'org',
    'URL_PARTLIST': baseurl + map + 'org/:orgid',
    'URL_APLIST': baseurl + devices + 'ap',
    'BLE_RANGE': 800
  })
  ...
  .service('localdata', function($http, pouchDB){
    ...
    //    title: '手术室',
    //    type: 'AMap.Polygon',
    //    data: { path: [[2160,0],[3240,0],[3240,488],[2160, 488]] }
    //  },{
    //    title: '手术室',
    //    type: 'AMap.Polygon',
    //    data: { path: [[3240,0],[4320,0],[4320,488],[3240, 488]] }
    //  },{
    //    title: '空',
    //    type: 'AMap.Polygon',
    //    data: { path: [[4320,0],[4680,0],[4680,488],[4320, 488]] }
    ...
    //    title: '六病房',
    //    type: 'AMap.Polygon',
    //    data: { path: [[360,732],[750,732],[750,1220],[360, 1220]] }
    //  },{
    //    title: '五病房',
    //    type: 'AMap.Polygon',
    //    data: { path: [[750,732],[1140,732],[1140,1220],[750, 1220]] }
    //  },{
    //    title: '四病房',
    //    type: 'AMap.Polygon',
    //    data: { path: [[1140,732],[1530,732],[1530,1220],[1140, 1220]] }
    //  },{
    //    title: '库房',
    //    type: 'AMap.Polygon',
    //    data: { path: [[1500,732],[1890,732],[1890,1220],[1500, 1220]] }
    ...
    //    title: '更衣室',
    //    type: 'AMap.Polygon',
    //    data: { path: [[2160,732],[3240,732],[3240,1220],[2160, 1220]] }
    //  },{
    //    title: '手术室',
    //    type: 'AMap.Polygon',
    //    data: { path: [[3240,732],[4230,732],[4230,1220],[3240, 1220]] }
    //  },{
    //    title: '空',
    //    type: 'AMap.Polygon',
    //    data: { path: [[4320,732],[4680,732],[4680,1220],[4320, 1220]] }
